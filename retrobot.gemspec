...
Gem::Specification.new do |gem|
  ...
  gem.description   = "Bot for twitter, which tweets a word that you've tweeted just 1 year ago"
  gem.summary       = "Retrobot tweets a word that you've tweeted just 1 year ago. (example: @mirakui_retro)"
